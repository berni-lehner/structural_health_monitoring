...
def mode_scorer(y_true, y_pred, target=None, default=-1.0):
    ...
    if len(y_true)==0:
        ...
        result = stats.mode(y_pred.astype(float).round(1)).mode[0]
...
def mode_count_scorer(y_true, y_pred, target=None, default=-1.0):
    ...
    if len(y_true)==0:
        ...
        result = stats.mode(y_pred.astype(float).round(1)).count[0]
    
    return result


def get_r2_scorer(target=None):
    scorer = make_scorer(r2_scorer, target=target,
                         greater_is_better=True)
...
def get_mse_scorer(target=None):
    scorer = make_scorer(mse_scorer, target=target,
                         greater_is_better=True)
    
    return scorer

def get_mse_range_scorer(limits=None):
    scorer = make_scorer(mse_range_scorer, limits=limits,
                         greater_is_better=True)
    
    return scorer

def get_mode_scorer(target=None):
    scorer = make_scorer(mode_scorer, target=target,
                         greater_is_better=True)
...
def get_mode_count_scorer(target=None):
    scorer = make_scorer(mode_count_scorer, target=target,
                         greater_is_better=True)
...
def get_pred_mean_scorer(target=None):
    scorer = make_scorer(mean_scorer, target=target,
                         greater_is_better=True)
...
class SHM_Scoring:
    __SYNTH_MSE_RESULTS = [#'test_mse_0.0',
        'test_mse_2.2', 'test_mse_2.5',
        'test_mse_2.8', 'test_mse_3.1',
        'test_mse_3.4', 'test_mse_3.8', 'test_mse_4.1',
        'test_mse_4.4', 'test_mse_4.7', 'test_mse_5.0',
        'test_mse_6.7', 'test_mse_8.3', 'test_mse_10.0',
        'test_mse_12.0', 'test_mse_14.0', 'test_mse_16.0',
        'test_mse_18.0', 'test_mse_20.0', 'test_mse_22.0',
        'test_mse_24.0', 'test_mse_26.0', 'test_mse_28.0',
        'test_mse_30.0', 'test_mse_32.0', 'test_mse_34.0',
        'test_mse_36.0', 'test_mse_38.0', 'test_mse_40.0',
                    ]
    __SYNTH_REL_ERROR = []
    __SYNTH_ABS_ERROR = []
    ...
    __REAL_MSE_RESULTS = [#'test_mse_0.0',
        'test_mse_1.5', 'test_mse_2.5',
        'test_mse_3.5', 'test_mse_4.5', 'test_mse_5.5',
        'test_mse_7.0', 'test_mse_8.0', 'test_mse_10.0',
        'test_mse_12.0', 'test_mse_14.0', 'test_mse_16.0',
        'test_mse_17.0', 'test_mse_19.0', 'test_mse_21.0',
        'test_mse_23.0', 'test_mse_25.0', 'test_mse_27.0',
        'test_mse_29.0', 'test_mse_31.0', 'test_mse_33.0',
        'test_mse_35.0', 'test_mse_37.0', 'test_mse_39.0',
        'test_mse_40.0',
        ]
